...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_valid_wall_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: sojammal <sojammal@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/25 23:27:17 by sojammal          #+#    #+#             */
/*   Updated: 2025/02/28 18:10:07 by sojammal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int ft_horizontal_wall(t_game *game)
{
    ...
    {
        x = 0;
        if (game->map->grid[x][y] != '1' || game->map->grid[game->map->cols - 1][y] != '1')
            return (0);
        y++;
    }
    return (1);
...
static int ft_vertical_wall(t_game *game)
{
    ...
    {
        y = 0;
        if (game->map->grid[x][y] != '1' || game->map->grid[x][game->map->rows - 1] != '1')
            return (0);
        x++;
    }
    return (1);
